...
@Getter
@Setter
@Schema(description = "Request to generate TOTP codes")
public class GenerateTotpRequestDto {

   @Schema(description = "Master password for decrypting stored secrets", example = "Master@456", requiredMode = Schema.RequiredMode.REQUIRED)
